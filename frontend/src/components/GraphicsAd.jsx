...
export const GraphicsAd = () => {
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/form-stats/category');
    ...
    const fetchTallaData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/form-stats/talla');
    ...
    const fetchTeamData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/form-stats/team');
    ...
    const fetchOriginData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/form-stats/origin');
  ...
  return (
    <div>
        <h1 className="titleUsers2">Registers</h1>
        <h2 className="subtitleUsers2">Graphs Of Registers</h2>
